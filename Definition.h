...
const static float viewVolumnFar = 2000.f;

const static glm::vec3 noLight(0.f, 0.f, 0.f);

const static glm::vec4 darkGreen(0.12f, 0.64f, 0.12f, 1.f);
const static glm::vec4 purple(0.5f, 0.f, 0.29f, 1.f);
...
const static float terrainWidth = 500.f, terrainHeight = 500.f, terrainDepth = 30.f;
